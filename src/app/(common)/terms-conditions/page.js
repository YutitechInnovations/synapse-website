          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 text-justify">
                ...
                <li>
                  Individuals must be legally capable of entering binding contracts under Indian law.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 text-justify">
                ...
                <li>
                  Turnaround times may vary based on complexity, volume, and clinical validation.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 text-justify">
                ...
                <li>Refer to our full Shipping & Delivery Policy.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 text-justify">
                ...
                <li>No refunds for digital services or treatment planning post-approval.</li>
                <li>Refer to our detailed Refund & Cancellation Policy.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 text-justify">
                ...
                <li>
                  Synapse HealthTech is a manufacturer and support provider; we do not assume clinical liability for treatment failure or patient dissatisfaction.
                </li>
              </ul>
            </div>
