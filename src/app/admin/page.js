...
export default function AdminLogin() {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center px-4 min-h-screen bg-[#F8FAF9]">
      <h1 className="text-3xl md:text-4xl font-bold text-center text-[#195B48] mt-8 mb-2">Admin Login</h1>
      <p className="text-base md:text-lg font-normal text-center text-[#195B48] mb-8">Access your Synapse admin dashboard</p>
      <div className="w-full max-w-md bg-white border border-[#195B48]/30 rounded-xl p-8 md:p-10 flex flex-col items-center shadow-sm">
        <h2 className="text-xl md:text-2xl font-semibold text-[#195B48] mb-1 w-full text-left">Admin Email</h2>
        <p className="text-base font-normal text-[#195B48] mb-6 w-full text-left">Enter your admin credentials to access the dashboard</p>
