        ...
        <div className="max-w-screen-lg mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-16">
            ...
            <div className="bg-white rounded-xl border border-[#006D38]/20 p-6">
              ...
              <p className="text-[32px] leading-[1.2] font-semibold text-[#006D38] mt-3">1650 pts</p>
            </div>

            <div className="bg-white rounded-xl border border-[#006D38]/20 p-6">
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="text-[14px] font-medium text-[#006D38] mb-1">Total Redeemed</h3>
                  <p className="text-[14px] text-[#006D38]/70">Points used for rewards</p>
                </div>
              ...
              <p className="text-[32px] leading-[1.2] font-semibold text-[#006D38] mt-3">400 pts</p>
            </div>
          </div>
              ...
              <table className="w-full border-spacing-0 min-w-[600px]">
                <thead>
                  <tr>
                    ...
                    <th className="text-left py-4 px-6 text-[14px] font-medium text-[#004C44] border-b border-[#004C44]/10">Description</th>
                    <th className="text-left py-4 px-6 text-[14px] font-medium text-[#004C44] border-b border-[#004C44]/10">Type</th>
                    <th className="text-left py-4 px-6 text-[14px] font-medium text-[#004C44] border-b border-[#004C44]/10">Points</th>
                  </tr>
                </thead>
                <tbody>
                  {rewardHistory.map((item, index) => (
                    <tr key={index}>
                      <td className="py-4 px-6 text-[14px] text-[#004C44] border-b border-[#004C44]/10">{item.date}</td>
                      <td className="py-4 px-6 text-[14px] text-[#004C44] border-b border-[#004C44]/10">{item.description}</td>
                      ...
                      <td className={`py-4 px-6 text-[14px] font-medium border-b border-[#004C44]/10 ${
                        item.type === 'Earned' ? 'text-[#22C55D]' : 'text-[#F59E0C]'
                      }`}>
                        {item.points}
                      </td>
                    </tr>
