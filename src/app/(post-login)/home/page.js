          ...
          <div className={styles.heroOverlay}>
            <div className="max-w-5xl px-4 sm:px-6 md:px-12 lg:px-12 py-12 md:py-24 lg:mt-20">
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-[1.25rem] font-medium text-[#004C44] leading-relaxed">
                ...
                every treatment journey. From meticulous treatment planning to
                diligent manufacturing, each solution is crafted for comfort,
                control, and optimal outcomes. Backed by the latest in 3D
                technology, our partnership is built around your expertise—and
