...
export default function PostLoginHome() {
  ...
  return (
    <div className="grid grid-rows-[auto_1fr_auto] min-h-screen w-full">
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroOverlay}>
          <div className="max-w-5xl px-4 sm:px-6 md:px-12 lg:px-12 py-12 md:py-24 lg:mt-20">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-[1.25rem] font-medium text-[#004C44] leading-relaxed">
              ...
              treatment journey. From meticulous treatment planning to diligent
              manufacturing, each solution is crafted for comfort, control, and
              optimal outcomes. Backed by the latest in 3D technology, our
              partnership is built around your expertise—and every smile you
              help create.
            </p>
          </div>
        </div>
        ...
        <div className={styles.rewardCards}>
          ...
          <div className="flex-1 bg-white rounded-xl border border-[#004C44] p-8 flex flex-col justify-between min-w-[260px] max-w-[400px] transition-shadow hover:shadow-lg">
            <div className="flex justify-between items-start mb-6">
              <div>
                <span className="text-[#004C44] text-lg font-bold block mb-1">
                  Current Balance
                </span>
                <span className="text-[#004C44] text-base font-normal">
          ...
          <div className="flex-1 bg-white rounded-xl border border-[#004C44] p-8 flex flex-col justify-between min-w-[260px] max-w-[400px] transition-shadow hover:shadow-lg">
            <div className="flex justify-between items-start mb-6">
              ...
              <span>
                ...
                >
                  <path
                    d="M25.2448 24.4885H1.51276V0.756378C1.51276 0.339108 1.17365 0 0.756378 0C0.339108 0 0 0.339108 0 0.756378V25.2436C0 25.6609 0.339108 26 0.756378 26H25.2436C25.6609 26 26 25.6609 26 25.2436C26.0013 24.8263 25.6621 24.4885 25.2448 24.4885Z"
                    fill="#22C55D"
                  />
                  <path
                    d="M5.16298 19.6479C5.51975 19.866 5.98491 19.7538 6.203 19.3983L9.10743 14.6548H17.082C17.3745 14.6548 17.6405 14.4858 17.7653 14.2211L21.8482 5.58462L22.0361 6.06618C22.1874 6.45569 22.626 6.64732 23.0156 6.49603C23.4051 6.34474 23.5967 5.90608 23.4454 5.51653L22.5781 3.29409C22.4269 2.90458 21.9882 2.71295 21.5986 2.86424L19.3762 3.73153C18.9867 3.8828 18.7951 4.32149 18.9463 4.71103C19.0976 5.10058 19.5363 5.29218 19.9258 5.14089L20.4881 4.92154L16.6016 13.1408H8.68255C8.41908 13.1408 8.17453 13.2782 8.03712 13.5025L4.91208 18.6079C4.694 18.9634 4.80624 19.4299 5.16298 19.6479Z"
                    fill="#22C55D"
                  />
                </svg>
              </span>
      ...
      <ConnectionFeatureSection
        isLoggedIn={true}
        onOrthoSyncClick={handleOrthoSync}
      />
