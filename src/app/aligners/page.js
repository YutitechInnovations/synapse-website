        ...
        <div className={`container mx-auto ${styles.heroContent} `}>
          <div className="max-w-3xl w-full">
            <h1 className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-[600] mb-6 leading-tight text-[#184C3A]">
              R<sub className="text-base font-[600] align-super">x</sub>.F.O.R.C.E™
            </h1>
      ...
      <section className="w-full flex justify-center mt-[100px]  bg-white py-12">
        <div className="w-full max-w-[1082px] flex flex-col px-2 sm:px-4 md:px-8 lg:px-0">
          <h2 className="text-3xl md:text-4xl font-[600] text-[#195B48] text-left mb-4">
            BioSmart™ Systems: Powered by <span className="font-[600]">R<sub className="text-base align-super">x</sub>.F.O.R.C.E<sup className="text-base">™</sup></span>
          </h2>
          ...
          <div className={styles.cardsRow}>
            <Link href="/aligners-biosmart-sm" className="flex-1">
              <div className={styles.card}>
                <div className="text-[1.4rem] font-[600] text-[#195B48] mb-4 text-center">BioSmart™ SM</div>
                <div className="text-[.9rem] font-semibold text-[#195B48] text-center">Our Shape Memory Aligner Option</div>
              </div>
            </Link>
            <Link href="/aligners-biosmart-t" className="flex-1">
              <div className={styles.card}>
                <div className="text-[1.4rem] font-[600] text-[#195B48] mb-4 text-center">BioSmart™ T</div>
                <div className="text-[.9rem] font-semibold text-[#195B48] text-center">Our Thermoformed Aligner Option</div>
              </div>
            </Link>
          </div>
          {/* Variant Container */}
          <div className={styles.variantContainer}>
            <div className={styles.variantText}>
              ...
              <ul className="text-lg text-[#195B48] list-disc pl-6">
                <li><span className="font-[400]">RxLight</span> – For mild to moderate cases</li>
                <li><span className="font-[400]">RxPro</span> – For moderate to advanced corrections</li>
                <li><span className="font-[400]">RxPro+</span> – For complex, multi-phase treatments</li>
              </ul>
            </div>
