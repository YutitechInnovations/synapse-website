  ...
  const handleImageChange = async (e) => {
    ...
    if (file) {
      try {
        ...
        const response = await getResearchPaperPresignedUrl(file.name);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === "success") {
        ...
        setError(response.message || "Failed to create research paper");
      }
    } catch (error) {
      ...
      if (
        ...
        setError(
          error.message || "Failed to create research paper. Please try again."
        );
      }
    } finally {
        ...
        <div className="flex items-center space-x-3 md:space-x-4 mb-4 md:mb-6">
          ...
          <div>
            ...
            <p className="text-sm md:text-base text-gray-600 mt-1">
              Create and publish a new research paper
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-r from-[#195B48] to-[#144636] px-4 md:px-6 lg:px-8 py-4 md:py-6">
          ...
          <p className="text-white/80 mt-1 text-sm md:text-base">
            Fill in the details below to create your new research paper
          </p>
        </div>
        ...
        >
          ...
          <div className="group">
            ...
            <input
              ...
              placeholder="Enter an engaging title for your research paper..."
