...
export default function EditResearchPaper() {
  ...
  useEffect(() => {
    const fetchPaper = async () => {
      try {
        // The slug parameter is actually the research_paper_id
        const paperId = slug;

        // Fetch the specific research paper using the paper ID
        ...
        if (paperResponse.status === "success" && paperResponse.data) {
          ...
          setBlogId(paperId); // Store the paper ID for update
        } else {
  ...
  */
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.title || !form.slug || !form.content) {
      setError("Title, paper link name, and content are required.");
      return;
    }

    if (!blogId) {
      setError(
        "Research paper ID not found. Please refresh the page and try again."
      );
      return;
    }
    ...
    try {
      ...
      const response = await updateResearchPaper(blogId, updateData);

      if (response.status === "success") {
        toast.success("Research paper updated successfully!");
        router.push("/admin/research-paper-management");
      } else {
        setError(response.message || "Failed to update research paper");
      }
    } catch (error) {
      console.error("Error updating research paper:", error);
      setError(
        error.message || "Failed to update research paper. Please try again."
      );
    } finally {
  ...
  if (error && error === "Research paper not found") {
    return (
      <div className="w-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen p-3 sm:p-4 md:p-6">
        ...
        <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl border border-gray-100 p-8 md:p-12 text-center max-w-md mx-auto">
          ...
          <p className="text-gray-600 mb-6 md:mb-8">
            The research paper you&apos;re trying to edit doesn&apos;t exist.
          </p>
          <Link
            href="/admin/research-paper-management"
          ...
          >
            ...
            Back to Research Paper Management
          </Link>
        </div>
      </div>
    );
        ...
        <div className="flex items-center space-x-3 md:space-x-4 mb-4 md:mb-6">
          ...
          <div>
            ...
            <p className="text-sm md:text-base text-gray-600 mt-1">
              Update the research paper content and details
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-r from-[#195B48] to-[#144636] px-4 md:px-6 lg:px-8 py-4 md:py-6">
          ...
          <p className="text-white/80 mt-1 text-sm md:text-base">
            Update the details below to modify your research paper
          </p>
        </div>
        ...
        >
          ...
          <div className="group">
            ...
            <input
              ...
              value={form.title}
              disabled
              placeholder="Paper title cannot be changed after creation"
            ...
            <p className="text-xs md:text-sm text-gray-500 mt-2 flex items-center">
              ...
              Paper title cannot be modified after creation. To change the
              title, please create a new research paper.
            </p>
          </div>
          ...
          <div className="group">
            ...
            <input
              ...
              placeholder="my-research-paper (no spaces, use hyphens)"
            ...
            <p className="text-xs md:text-sm text-gray-500 mt-2 flex items-center">
              ...
              This will be used in the paper&apos;s web address. Use only
            ...
            <div className="group">
              ...
              {form.image && (
                <div className="relative">
                  <Image
                    src={form.image}
                    alt="Current Research Paper Image"
                    width={400}
                    height={192}
          ...
          <div className="group">
            ...
            <textarea
              ...
              value={form.summary}
              onChange={handleChange}
              placeholder="A short summary of your research paper (will appear in the research paper list)..."
          ...
          <div className="group">
            ...
            <textarea
              ...
              value={form.content}
              onChange={handleChange}
              placeholder="Write your research paper content here. You can use paragraphs by separating them with double line breaks..."
              className="w-full px-4 md:px-6 py-3 md:py-4 border-2 border-gray-200 rounded-lg md:rounded-xl focus:ring-4 focus:ring-[#195B48]/20 focus:border-[#195B48] transition-all duration-300 resize-none bg-white hover:border-gray-300"
              rows="10 md:rows-12"
              required
            />
