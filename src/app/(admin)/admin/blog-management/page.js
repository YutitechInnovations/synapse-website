        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 lg:gap-6">
          <div className="flex items-center space-x-3 md:space-x-4">
            ...
            <div>
              ...
              <p className="text-sm md:text-base text-gray-600 mt-1">Manage and organize your blog content</p>
            </div>
          </div>
          ...
          >
            <svg className="w-4 h-4 md:w-5 md:h-5 mr-2 group-hover:rotate-90 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl border border-gray-100 overflow-hidden">
        <div className="p-4 md:p-6 lg:p-8 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-[#195B48] mb-2">All Blogs</h2>
              <p className="text-sm md:text-base text-gray-600">Manage and edit your blog posts with ease</p>
            </div>
        ...
        {isLoading ? (
          <div className="text-center py-12 md:py-20">
            <div className="relative">
              ...
              <div className="absolute inset-0 w-12 h-12 md:w-16 md:h-16 border-4 border-transparent border-t-[#195B48]/40 rounded-full animate-spin mx-auto" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
            </div>
            <p className="text-gray-600 text-base md:text-lg font-medium">Loading blogs...</p>
          ...
          <div className="text-center py-12 md:py-20">
            <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-red-100 to-red-200 rounded-full flex items-center justify-center mx-auto mb-6 md:mb-8 shadow-lg">
              <svg className="w-10 h-10 md:w-12 md:h-12 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
              </svg>
            </div>
            <h3 className="text-xl md:text-2xl font-bold text-[#195B48] mb-4">Oops! Something went wrong</h3>
            <p className="text-gray-600 mb-6 md:mb-8 max-w-md mx-auto px-4">{error}</p>
            <button
              onClick={fetchBlogs}
                  ...
                  >
                    ...
                    <td className="px-4 md:px-6 py-4 md:py-6 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        >
                          <svg className="w-3 h-3 md:w-4 md:h-4 mr-1 group-hover/edit:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        >
                          <svg className="w-3 h-3 md:w-4 md:h-4 mr-1 group-hover/delete:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="text-center py-12 md:py-20">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-[#195B48] mb-4">No blogs yet</h3>
            <p className="text-gray-600 mb-6 md:mb-8 max-w-md mx-auto px-4">Get started by creating your first blog post to share insights with your audience.</p>
            <Link
              href="/admin/blog-management/create"
