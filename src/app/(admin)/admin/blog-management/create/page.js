    ...
    <div className="w-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen p-3 sm:p-4 md:p-6">
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div className="flex items-center space-x-3 md:space-x-4 mb-4 md:mb-6">
          ...
          <div>
            ...
            <p className="text-sm md:text-base text-gray-600 mt-1">Create and publish a new blog post for the orthodontic community</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-r from-[#195B48] to-[#144636] px-4 md:px-6 lg:px-8 py-4 md:py-6">
          ...
          <p className="text-white/80 mt-1 text-sm md:text-base">Fill in the details below to create your new blog post</p>
        </div>
                  ...
                  <div className="mt-4 rounded-lg md:rounded-xl max-h-40 md:max-h-48 border-2 border-gray-200 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
                    <div className="text-center py-6 md:py-8">
                      <div className="relative">
                        ...
                        <div className="absolute inset-0 w-6 h-6 md:w-8 md:h-8 border-4 border-transparent border-t-[#195B48]/40 rounded-full animate-spin mx-auto" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
                      </div>
                      <p className="text-xs md:text-sm text-gray-600 font-medium">Uploading image...</p>
                    </div>
                  </div>
                ) : (
                  <div className="mt-4">
