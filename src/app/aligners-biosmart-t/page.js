      ...
      <div className="bg-[#F6F6F3] min-h-screen w-full">
        ...
        <section className="w-full flex flex-col items-center px-4 md:px-0 bg-white">
          <div className="max-w-5xl w-full mt-16 mb-16 flex flex-col gap-24">
            {/* Models That Keep Up */}
            <div className="max-w-[900px] mx-auto pl-12 mb-16">
            ...
            <div className="flex flex-col md:flex-row items-center gap-16">
              ...
              <div className="flex-1 flex justify-end items-center">
                <img 
                  ...
                  style={{ width: '500px', height: '456px', marginLeft: '63px', objectFit: 'contain', borderRadius: '16px' }}
                />
              </div>
            </div>
            ...
            <div className="w-[1240px] h-[458px] rounded-[20px] bg-white flex flex-row justify-between items-center mx-auto" style={{ paddingTop: '100px', paddingBottom: '100px' }}>
              <div className="flex-1 flex flex-col justify-center pl-12 pr-8">
                <h2 className="text-4xl font-bold text-[#004C44] mb-6 leading-tight">Patient-Friendly,<br />Clinician-Ready.</h2>
                <p className="text-xl text-[#195B48]">Built for flexibility and strength, these aligners handle complex movements with confidence—while offering a break-resistant, attachment-compatible surface clinicians trust.</p>
              </div>
              <div className="flex-1 h-full flex items-center justify-end">
                <img 
                  src="/images/patient.jpg" 
                  alt="Patient Friendly" 
                  style={{ width: '625px', height: '456px', objectFit: 'cover', borderRadius: '20px' }}
                />
              </div>
            </div>
        ...
        <section className="w-full flex flex-col items-center px-4 md:px-0 bg-[#F6F6F3] py-16 pb-[150px]">
          <div className="max-w-[1169px] mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#195B48] mb-4 leading-tight">Thermoformed Aligners.<br />Classic. Reinforced. Reliable.</h2>
            <p className="mb-8 text-[#195B48] text-lg">Please choose your desired Tier of BioSmart™ T based on your case specifications as per the below table.</p>
